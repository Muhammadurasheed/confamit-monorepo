      ...
      <div className="hidden lg:flex w-1/2 p-16 flex-col justify-between items-start bg-[#F5F5F7] relative overflow-hidden saturate-[1.1]">
        ...
        >
          <p className="text-[19px] font-medium text-[#1D1D1F]/80 leading-snug">
            Verify bank accounts instantly and secure <br /> payments with the Hedera P2P Escrow link.
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <div className="text-left space-y-2">
            ...
            <p className="text-[17px] text-[#86868B] font-medium leading-relaxed">
              Log in to manage your trusted transactions.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative py-2 flex items-center justify-center">
              ...
              <span className="relative bg-white px-4 text-[#86868B] text-sm font-medium">or login with email</span>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                <Label htmlFor="email" className="text-[14px] font-semibold text-[#1D1D1F] opacity-90">Email</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <Label htmlFor="password" title="password" className="text-[14px] font-semibold text-[#1D1D1F] opacity-90">Password</Label>
                  <Link to="/forgot-password" title="forgot-password" className="text-[13px] text-[#007AFF] font-bold hover:underline">
                    Forgot?
                  </Link>
                </div>
              ...
              <div className="flex items-center space-x-3 pt-1">
                <Checkbox
                  ...
                  className="w-5 h-5 rounded-md border-[#D2D2D7] data-[state=checked]:bg-[#007AFF] data-[state=checked]:border-[#007AFF] ring-offset-white focus-visible:ring-2 focus-visible:ring-[#007AFF]/20 transition-all"
                />
                <Label
                  htmlFor="remember"
                  className="text-[15px] font-medium text-[#1D1D1F]/90 cursor-pointer"
                >
                  Stay signed in
                </Label>
              </div>
